...
printf("sizeof PercussionNote %d\n",sizeof(PercussionNote));
...
seed=134;
//seed=time(NULL);
    SongCreator *songCreator = new SongCreator(seed,240);



    songCreator->createSong(structureScript,arrangementScript,&midiWriter);
