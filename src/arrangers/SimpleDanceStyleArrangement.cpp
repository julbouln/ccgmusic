...
void SimpleDanceStyleArrangement::arrange(Song *s)
{
    ...
    int cnt = 0;
    int chorus_cnt = 0;
    int attack_seed = this->rndInt(0, 32000);
    ...
    int drum_seed1 = this->rndInt(0, 32000);
    int drum_seed2 = this->rndInt(0, 32000);
    int arp_seed = this->rndInt(0, 32000);
    for (int i = 0; i < s->getParts(); ++i )
    {
        ...
        else
        {
            if (s->getPart(i)->getArrHint() == 1 || s->getPart(i)->getArrHint() == 3)
            {
                ...
                s->addRenderEvent("Simple Melody", this->rndInt(0, 32000), 0, s->getPartStartBar(i), s->getPartEndBar(i), 2, this->createTime(0, back), 0.7);
                s->addRenderEvent("Simple Melody", this->rndInt(0, 32000), 0, s->getPartStartBar(i), s->getPartEndBar(i), 2, this->createTime(0, 2 * back), 0.5);
                s->addRenderEvent("Simple Melody", this->rndInt(0, 32000), 0, s->getPartStartBar(i), s->getPartEndBar(i), 2, this->createTime(0, 3 * back), 0.3);
            }
            if (s->getPart(i)->getArrHint() == 2 || s->getPart(i)->getArrHint() == 3)
            {
                ...
                s->addRenderEvent("Simple Melody", this->rndInt(0, 32000), 1, s->getPartStartBar(i), s->getPartEndBar(i), 2, this->createTime(0, back), 0.7);
                s->addRenderEvent("Simple Melody", this->rndInt(0, 32000), 1, s->getPartStartBar(i), s->getPartEndBar(i), 2, this->createTime(0, 2 * back), 0.5);
                s->addRenderEvent("Simple Melody", this->rndInt(0, 32000), 1, s->getPartStartBar(i), s->getPartEndBar(i), 2, this->createTime(0, 3 * back), 0.3);
            }
        }
        if (s->getPart(i)->getArrHint() == 3)
        {
            ...
            {
                s->addRenderEvent("Shortest Way Chords Simple", this->rndInt(0, 32000), 2, s->getPartStartBar(i), s->getPartEndBar(i), 1, this->createTime(0, 0), 0.85);
                s->addRenderEvent("Shortest Way Chords Simple", this->rndInt(0, 32000), 6, s->getPartStartBar(i), s->getPartEndBar(i), 2, this->createTime(0, 0), 0.70);
            }
            ...
            if (chorus_cnt > 2)
            {
                s->addRenderEvent("Simple Melody", this->rndInt(0, 32000), 8, s->getPartStartBar(i), s->getPartEndBar(i), this->rndInt(2, 3), this->createTime(0, 0), 1.0);
            }
            ++chorus_cnt;
        }
        else
        {
            ...
            if (cnt == 0)
            {
                ...
                s->addRenderEvent("Simple Bass", this->rndInt(0, 32000), 3, s->getPartStartBar(i), s->getPartEndBar(i), -1, this->createTime(0, 0), 1.0);
            }
            else
            {
                if (cnt >= 1)
                {
                    s->addRenderEvent("Shortest Way Chords Simple", this->rndInt(0, 32000), 2, s->getPartStartBar(i), s->getPartEndBar(i), 1, this->createTime(0, 0), 0.75);
                    s->addRenderEvent("Random Bass", 2, 3, s->getPartStartBar(i), s->getPartEndBar(i), -1, this->createTime(0, 0), 1.0);
                    s->addRenderEvent("Shortest Way Chords Simple", this->rndInt(0, 32000), 6, s->getPartStartBar(i), s->getPartEndBar(i), 2, this->createTime(0, 0), 0.65);
                }
            }
            ...
            {
                s->addRenderEvent("Arpeggio Chords Fast", this->rndInt(0, 32000), 4, s->getPartStartBar(i), s->getPartEndBar(i), 1, this->createTime(0, 0.0), 0.9);
            }
            s->addRenderEvent("Sine Velocity Simple Melody", this->rndInt(0, 32000), 9, s->getPartStartBar(i), s->getPartEndBar(i), 2, this->createTime(0, 0.0), 0.9);
            ++cnt;
        }
    }
}
